...
int main(int argc, char** argv) {
    ...
    for (int i=0; i<nBins; i++) {
        ...
        upper[i] = ff.GetRightBoundary(upperN, FitOpt);
    ...
    TF1* funcUpper = new TF1("fUpper", "[0] + [1] / pow(x, [2])", 0, x2);
    TF1* funcLower = new TF1("fLower", "[0] + [1] / pow(x, [2])", 0, x2);
    ...
    std::cout << funcUpper->GetParameter(0) << ", " << funcUpper->GetParameter(1) << ", " << funcUpper->GetParameter(2) << std::endl;
    std::cout << "[LOG] - From Main: The fit results: Lower line polynomial(3) parameters are: ";
    std::cout << funcLower->GetParameter(0) << ", " << funcLower->GetParameter(1) << ", " << funcLower->GetParameter(2) << std::endl;
